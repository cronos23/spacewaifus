...
public:
    ...
    void setupUi(QWidget *mainmenu)
    {
        ...
        mainmenu->setMinimumSize(QSize(880, 693));
        mainmenu->setMaximumSize(QSize(880, 693));
        QIcon icon;
        ...
        play_button->setGeometry(QRect(330, 240, 191, 91));
        QFont font1;
        ...
        controls_button->setGeometry(QRect(330, 390, 191, 71));
        QFont font2;
        ...
        quit_button->setGeometry(QRect(330, 500, 191, 71));
