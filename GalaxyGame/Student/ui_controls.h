...
public:
    ...
    void setupUi(QWidget *controls)
    {
        ...
        controls_label->setGeometry(QRect(70, 170, 301, 141));
        QFont font2;
        ...
        tips_label->setGeometry(QRect(80, 360, 701, 221));
    ...
    void retranslateUi(QWidget *controls)
    {
        ...
        tips_label->setText(QApplication::translate("controls", "<html><head/><body><p>The point of the game blablabla</p></body></html>", 0));
